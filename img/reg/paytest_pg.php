...
$querys="SELECT * FROM payment_log WHERE applicant_id='$stdid' and PaymentCategory='Registration Fee' and PaymentState='Paid' and PaymentSession='$session'";	
...
include_once('payrequest_pg.php');
...
include_once('goto_interwish.php');
	...
	$result2 = mysqli_query($dbc, $query2);	
				...
				if(mysqli_num_rows($result2)==0){
					...
					include_once('fail_transact_pg.php');
				}					
}
