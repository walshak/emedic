...
<form action="" form method="post" enctype="multipart/form-data" >
  ...
  <table width="597" height="110" border="0" align="center">
    ...
    <tr>
      <td width="130" height="16" class="tfont"><strong>Transaction ID/RRR</strong></td>
      ...
      <td class="tfont"><strong>Requery Attempts</strong></td>
    </tr>
    <tr>
      <td height="16" class="tfont">&nbsp;</td>
      <td class="tfont">&nbsp;</td>
  ...
  <table width="597" height="24" border="0" align="center">
	...
	$query="SELECT * FROM payment_log WHERE applicant_id ='$stdid' and PaymentCategory='Registration Fee' and PaymentSession='$session' and CurrentSessionPayment='$pay_type'";	
    ...
    <tr>
      <td width="130" height="20" class="tfont"><?php echo $row['PaymentID'] .'<br>RRR:'. $row['RRR']; ?></td>
      <td width="143"><?php echo '<a href="main.php?' . 'orderID=' . $row['PaymentID'] . '&stdid=' . $urlstdid .  '&view=reqry'.'">RE-QUERY</a>'; ?></td>
...
$urlstdid=encode("$en_urlstdid","$mykey");
		...
		$pay_detail=$amt . '_' . $session . '_' . $pay_type;
		$url_pay2=encode("$pay_detail","$mykey");
		
   ?>
      <td height="20" colspan="4" class="tfont"><div align="center"><?php echo '<a href="main.php?' . 'stdid=' . $urlstdid .'&view=' . 'payreq_try_pg' . '&pdesc2=' . $url_pay2 .'">Initiate New Payment</a>'; ?></div>
