...
$urlstdid=encode("$en_urlstdid","$mykey");
   ...
   ?>
      <td height="20" colspan="4" class="tfont"><div align="center"><?php echo '<a href="main.php?' . 'stdid=' . $urlstdid .'&view=' . 'payreq_try_pg_sem' . '&amt=' . $amt . '&p=' . $p .'">Initiate New Payment</a>'; ?></div>
