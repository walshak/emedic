...
if (isset($_POST['uploadDocumentBtn'])) {
    ...
    if (!empty($hospital_no)) {
        ...
        if ($imageFileType == 'pdf' || $imageFileType == 'jpg' || $imageFileType == 'png' || $imageFileType == 'jpeg') {
            ...
            /*			        $targetDirectory = "../documents/patients/";
			  $targetFile = $targetDirectory . basename($_FILES["document_file"]["name"]);
			
			            if (move_uploaded_file($_FILES["document_file"]["tmp_name"], $target_file)) {
                echo "File uploaded successfully: " . htmlspecialchars(basename($_FILES["document_file"]["name"]));
            } else {
