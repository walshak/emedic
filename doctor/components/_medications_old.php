    ...
    <div class="row">
        <div class="col-md-5">
            <div class="form_sep">
                ...
                <input type="text" style="padding: 20px" class="typeahead form-control typeahead_elem " data-provide="typeahead" id="drug_search_typeahead" placeholder="Enter First 3 Letters of Drug or Brand Name" autocomplete="off">
