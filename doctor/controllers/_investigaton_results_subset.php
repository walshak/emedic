                ...
                ?>
                    ...
                    <?php if ($is_img): ?>
                        <div style="margin-top: 5px; margin-bottom: 5px;">
                            <img src="../investigations/uploads/<?php echo htmlspecialchars($req_no . '.' . $investigation_['attachment']); ?>" alt="Attached Image" style="max-width: 100%; max-height: 250px; border: 1px solid #ccc; border-radius: 4px; padding: 2px;">
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
