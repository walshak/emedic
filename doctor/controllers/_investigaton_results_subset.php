...
if ($investigation_field_stmt->rowCount() > 0) {
    ...
    if ($field_type == 'value') {
        ...
        if ($investigation_result_stmt->rowCount() > 0) {
            ...
            if (!empty($investigation_result_info['comment'])) {
                echo '<b><span style="color:red;">Comment:</span> ' . $investigation_result_info['comment'] . ' <br>';
            } else {
                echo '<b>Comment: ' . $investigation_['result_comment'] . ' <br>';
            }

            echo '<b>Entered by: ' . $investigation_result_info['entered_by'] . ' <br> 
    ...
    if ($field_type == 'values') {
        ...
        if ($investigation_result_stmt->rowCount() > 0) {
            ...
            if (!empty($investigation_result_info['comment'])) {
                echo '<b><span style="color:red;">Comment:</span> ' . $investigation_result_info['comment'] . ' <br>';
            } elseif (!empty($investigation_['result_comment'])) {
                echo '<b><span style="color:red;">Comment:</span> ' . $investigation_['result_comment'] . ' <br>';
            } else {
                echo '<b>Comment: ' . $investigation_['result_comment'] . ' <br>';
            }
    ...
    if ($field_type == 'report') {
        ...
        if ($investigation_result_stmt->rowCount() > 0) {
            ...
            <br>
            <small>
            <b>Requested by333: ' . $investigation_['request_by'] . ' <br>
            <b>Requested On: ' . dateFormat_($investigation_['request_date']) . ' <br>
            <b>Status: ' . $lab_status . ' <br>';
