...
if(isset($_GET['emr'])){
	...
	$stmt=$db->query("SELECT bal FROM pharm_ext WHERE transc_code='$emr'");
	 			if($stmt->rowCount()>0){
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        ...
                        <a href="archive.php?emr=<?php echo $emr; ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Close & Return to Previous Page"><i class="fa fa-times"></i> Close</a>
                    </div>
                </div>
            </div>
