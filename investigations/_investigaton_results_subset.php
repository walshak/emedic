    ...
    if ($field_type == 'value') {
        ...
        if ($investigation_result_stmt->rowCount() > 0) {
            ...
            echo '<div style="max-width: 500px; padding:20px;border:2px solid #000; display:inline-block"> 
									...
									<b>Requested On:  ' .  date('d-M-Y', strtotime($investigation_['request_date'])) . ' <br>
									<b>Status:  ' . $lab_status . ' <br>
									<b>Comment:  ' . $investigation_['result_comment'] . ' <br> 
									<b>Entered by:  ' . $investigation_result_info['entered_by'] . ' <br> 
									Date:  ' .  date('d-M-Y', strtotime($investigation_result_info['result_date'])) . '</b></small>
                                                </div>';
        }
    }
    ...
    if ($field_type == 'report') {
        ...
        if ($investigation_result_stmt->rowCount() > 0) {
            ...
            echo '<div style="max-width: 500px; padding:20px;border:2px solid #000; display:inline-block">  ' . $result . '
									...
									<b>Requested On:  ' . ($investigation_['request_date']) . ' <br>
									<b>Status:  ' . $lab_status . ' <br>
                                    <b>Comment:  ' . $investigation_['result_comment'] . ' <br> 
									<b>Entered by:  ' . $investigation_result_info['entered_by'] . ' <br> 
									Date:  ' .  date('d-M-Y', strtotime($investigation_result_info['result_date'])) . '</b></span>
                                    </div>';
        } else {
            echo '';
        }
