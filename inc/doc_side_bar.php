        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img alt="image" class="img-circle" src="<?php if (file_exists(staff_p . $uname . '.' . 'jpg')) {
                                                                        echo staff_p . $uname . '.' . 'jpg';
                                                                    } else {
            ...
            <li>
                <a href="index.php?doc"><i class="fa fa-user-md"></i> <span class="nav-label">Services and Revenue Generated</span> </a>
            </li>

            <li>
                <a href="index.php?vts"><i class="fa fa-user-md"></i> <span class="nav-label">Activities & Logs</span> </a>
            </li>
