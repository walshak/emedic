     <?php
        ...
        if (isset($_POST['vitals_links'])) {
            ...
            $hx_stmt = $db->prepare("SELECT * FROM vital_sign WHERE hospital_no = ? and $vital IS NOT NULL AND status = '1' ORDER BY sn desc LIMIT 150");
                     ...
                     <tbody id="">
                         <?php
                            ...
                            foreach ($vitals as $key => $rwx) {
                                $date = date('d M, Y h:i A', strtotime('' . $vital["category"]));
     ...
     <?php exit;
        ...
        if (isset($_POST['save-vitals-btn'])) {
            ...
            $colums = '';
            $col_values = '';
            $col_value_arr = [$hospital_no,  $_SESSION["fullname"]];
            $keys = [];

            $limit = 2;
            foreach ($post_keys as $key => $_key_) {
                if ($_key_ == 'hospital_no') continue;
            ...
            $sql = "INSERT INTO `vital_sign`( `hospital_no`,`prepared_by`, $colums) VALUES (?, ?, $col_values)";
            $stmt = $db->prepare($sql);
            $saved = $stmt->execute($col_value_arr);
            if ($saved) {
                $error_status = 2;
                $error_msg = 'Success : Vitals Saved Successfully';
            }
        }
         ...
         <div class="row">
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="temp" name="temp" class="form-control" maxlength="4" onkeyup="checkPass3()">
             ...
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="number" id="weight" name="weight" class="form-control" maxlength="4">
         ...
         <div class="row">
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="resp_rate" name="resp_rate" class="form-control" maxlength="4">
             ...
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="height" name="height" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="pulse_read" name="pulse_read" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
             ...
             <div class="col-md-6">
                 <div class="form_sep">
                     <label>MUAC (cm)</label>
                     <input type="text" id="muac_read" name="muac_read" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="spo2" name="spo2" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
             ...
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="fbs" name="fbs" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             ...
             <div class="col-md-6">
                 <div class="form_sep">
                     ...
                     <input type="text" id="rbs" name="rbs" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
             <div class="col-md-6">
                 <div class="form_sep">
                     <label>PPBS</label>
                     <input type="text" id="ppbs" name="ppbs" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             <div class="col-md-6">
                 ...
                 <div class="form_sep">
                     ...
                     <input type="text" id="GTT" name="GTT" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
             </div>
             <div class="col-md-6">
                 ...
                 <div class="form_sep">
                     <label>Others</label>
                     <input type="text" id="Others" name="Others" class="form-control" maxlength="4">
                     <span class="confirmMessage" id="confirmMessage"></span>
                 </div>
         ...
         <div class="row">
             ...
             <div class="col-md-12">
                 ...
                 <div align="left" class="form_sep">
                     <button type="submit" class="btn btn-success" name="save-vitals-btn">Save Vitals</button>
                 </div>
             </div>
