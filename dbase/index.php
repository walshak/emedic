...
if ($rights == 'NS' or $rights == 'DR' or $rights == 'AD'  or $rights == 'PH' or $rights == 'AD' or $rights == 'MD') {
                        ...
                        <div class="x_content">
                          ...
                          <tbody>';
                            ...
                            if (isset($_POST['generate_report_appt_stats'])) {
                                ...
                                // Bind parameters for start and end dates
                            ...
                            ?>
                                ...
                                <div class="print-section" id="admission-stats">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="#" class="view-admit-details"
                                                        data-status="Ward Admissions"
                                                        data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                        data-end_date="<?php echo htmlspecialchars($endDate); ?>"><?php echo $wardAdmissions; ?></a></td>
                                                <td><a href="#" class="view-admit-details"
                                                        data-status="A & E Admissions"
                                                        data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                        data-end_date="<?php echo htmlspecialchars($endDate); ?>"><?php echo $aeObservations; ?></a></td>
                                                <td><a href="#" class="view-admit-details"
                                                        data-status="All Admissions"
                                                        data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                        data-end_date="<?php echo htmlspecialchars($endDate); ?>"><?php echo $totalAdmissions; ?></a></td>
                                                ...
                                                <td><a href="#" class="view-admit-details"
                                                        data-status="Death"
                                                        data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                        data-end_date="<?php echo htmlspecialchars($endDate); ?>"><?php echo  round(($mortalityStats / $dischargesCount) * 100, 4); ?>% (<?php echo $mortalityStats ?> Deaths)</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($appointmentsBySpecialist as $specialist) { ?>
                                                <tr>
                                                    <td>
                                                        <a href="#" class="view-specialist-details"
                                                            data-specialist="<?php echo htmlspecialchars($specialist['services_name']); ?>"
                                                            data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                            data-end_date="<?php echo htmlspecialchars($endDate); ?>">
                                                            <?php echo htmlspecialchars($specialist['services_name']); ?>
                                                        </a>
                                                    </td>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($serviceStats as $service): ?>
                                                <tr>
                                                    <td>
                                                        <a href="#" class="view-details" data-service="<?php echo htmlspecialchars($service['service_name']); ?>" data-start_date="<?php echo htmlspecialchars($startDate); ?>" data-end_date="<?php echo htmlspecialchars($endDate); ?>">
                                        ...
                                        <tbody>
                                            <?php foreach ($dischargeStats as $discharge) { ?>
                                                <tr>
                                                    <td>
                                                        <a href="#"
                                                            class="view-discharge-details"
                                                            data-discharge_status="<?php echo htmlspecialchars($discharge['discharge_status']); ?>"
                                                            data-start_date="<?php echo $startDate; ?>"
                                                            data-end_date="<?php echo $endDate; ?>">
                                                            <?php echo ($discharge['discharge_status'] != '') ? htmlspecialchars($discharge['discharge_status']) : 'N/A'; ?>
                                                        </a>
                                                    </td>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($cancellationStats as $status) { ?>
                                                <tr>
                                                    <td><a href="#" class="view-status-details"
                                                            data-status="<?php echo htmlspecialchars($status['status']); ?>"
                                                            data-start_date="<?php echo htmlspecialchars($startDate); ?>"
                                                            data-end_date="<?php echo htmlspecialchars($endDate); ?>"><?php echo htmlspecialchars($status['status']); ?></a></td>
                            ...
                            <div class="modal fade" id="specialistDetailModal" tabindex="-1" role="dialog" aria-labelledby="specialistDetailLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="specialistDetailLabel">Service Details</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body" id="specialistDetailModalBody">
                            ...
                            <div class="modal fade" id="dischargeDetailModal" tabindex="-1" role="dialog" aria-labelledby="dischargeDetailModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="dischargeDetailModalLabel">Discharge Details</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body" id="dischargeDetailModalBody">
                            ...
                            <div class="modal fade" id="statusDetailModal" tabindex="-1" role="dialog" aria-labelledby="statusDetailModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="statusDetailModalLabel">Appointment Details</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                            ...
                            <div class="modal fade" id="admitStatusModal" tabindex="-1" role="dialog" aria-labelledby="admitStatusModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="admitStatusModalLabel">Admission Types</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body" id="admitStatusModalBody">
                                            <!-- Content dynamically loaded -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    document.querySelectorAll(".view-details").forEach(element => {
                                        element.addEventListener("click", function(event) {
                                            ...
                                            fetch(`fetch_details.php?med_service_detail_name=${(service)}&start_date=${startDate}&end_date=${endDate}`, {
                                                    method: "GET",
                                                    headers: {
                                                ...
                                                .then(data => {
                                                    ...
                                                    data.forEach(entry => {
                                                        modalTableBody.innerHTML += `
                                                            <tr>
                                                                <td>${entry.hospital_no}</td>
                                                                <td>${entry.app_no}</td>
                                                                <td>${entry.consultant_name || "N/A"}</td>
                                                                <td>${entry.notes || "No notes"}</td>
                                                                <td>${entry.isCompleted == 1 ? "Complete" : "Incomplete"}</td>
                                ...
                                // speciallist services js
                                document.addEventListener("DOMContentLoaded", function() {
                                    const modalBody = document.getElementById("specialistDetailModalBody");

                                    document.querySelectorAll(".view-specialist-details").forEach(link => {
                                        link.addEventListener("click", function(event) {
                                            ...
                                            fetch(`fetch_details.php?specialist=${encodeURIComponent(specialist)}&start_date=${startDate}&end_date=${endDate}`)
                                                .then(response => response.json())
                                                .then(data => {
                                                    modalBody.innerHTML = `
                                                        <h5>Appointments for ${specialist}</h5>
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Appointment No</th>
                                                                    <th>Appointment Doc</th>
                                                    ...
                                                    $("#specialistDetailModal").modal("show");
                                                })
                                ...
                                // discharge stats js
                                document.addEventListener("DOMContentLoaded", function() {
                                    const modalBody = document.getElementById("dischargeDetailModalBody");

                                    document.querySelectorAll(".view-discharge-details").forEach(link => {
                                        link.addEventListener("click", function(event) {
                                            event.preventDefault();

                                            const dischargeStatus = this.getAttribute("data-discharge_status");
                                            const startDate = this.getAttribute("data-start_date");
                                            const endDate = this.getAttribute("data-end_date");

                                            fetch(`fetch_details.php?discharge_status=${encodeURIComponent(dischargeStatus)}&start_date=${startDate}&end_date=${endDate}`)
                                                .then(response => response.json())
                                                .then(data => {
                                                    modalBody.innerHTML = `
                                                        <h5>Details for ${dischargeStatus || "N/A"}</h5>
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Hospital No</th>
                                                            ...
                                                            <tbody>
                                                                ${data.map(item => `
                                                                    <tr>
                                                                        ...
                                                                        <td>${item.app_no}</td>
                                                                        <td>${item.date_admit}</td>
                                                                        <td>${item.doc_incharge}</td>
                                                                        <td>${item.date_discharge}</td>
                                                                        <td>${item.discharge_name}</td>
                                                                        <td>${item.discharge_note}</td>
                                                                    </tr>
                                                                `).join("")}
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    $("#dischargeDetailModal").modal("show");
                                                })
                                                .catch(error => console.error("Error fetching details:", error));
                                        });
                                    });
                                ...
                                // apptm conclusion js 
                                document.addEventListener("DOMContentLoaded", function() {
                                    const modalBody = document.getElementById("statusDetailModalBody");

                                    document.querySelectorAll(".view-status-details").forEach(button => {
                                        button.addEventListener("click", function() {
                                            const status = this.getAttribute("data-status");
                                            const startDate = this.getAttribute("data-start_date");
                                            const endDate = this.getAttribute("data-end_date");

                                            fetch(`fetch_details.php?conclusion_status=${encodeURIComponent(status)}&start_date=${startDate}&end_date=${endDate}`)
                                                .then(response => response.json())
                                                .then(data => {
                                                    modalBody.innerHTML = `
                                                        <h5>Details for Status: ${status}</h5>
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Appointment No</th>
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    const modalBody = document.getElementById("admitStatusModalBody");

                                    document.querySelectorAll(".view-admit-details").forEach(button => {
                                        button.addEventListener("click", function() {
                                            const status = this.getAttribute("data-status");
                                            const startDate = this.getAttribute("data-start_date");
                                            const endDate = this.getAttribute("data-end_date");

                                            fetch(`fetch_details.php?admit_status=${encodeURIComponent(status)}&start_date=${startDate}&end_date=${endDate}`)
                                                .then(response => response.json())
                                                .then(data => {
                                                    modalBody.innerHTML = `
                                                        <h5>Details for ${status || "N/A"}</h5>
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Hospital No</th>
	...
	where e.vip=0 and date(med.date_entry) between '$start3' and '$end3' and med.notes like '%$search_compl%'  ORDER BY med.sn");
                                ...
                                ?>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $stmt = $db->query("SELECT med.*,e.surname,e.fname,e.phone,e.age,e.gender,e.addr,e.dob,e.occupation FROM enrollee as e 
                      inner join notes as med on e.hospital_no=med.hospital_no where e.vip=0 and date(med.date_entry) between '$start3' and '$end3' and med.notes like '%$search_compl%' and med.notes_type='D'  ORDER BY sn");
                                    ...
                                    if (isset($_POST['version_2'])) {
                                        ...
                                        if ($patient_way == "OUT-PATIENT") {
                                            $stmt = $db->query("SELECT a.*,e.nhis_no,e.phone,e.surname,e.fname,e.oname,e.age,e.gender FROM apptm a 
                      INNER JOIN enrollee AS e ON e.hospital_no = a.hospital_no
                       where doctor_id >0  $tag AND e.vip =0 and date_ap between '$start2' and '$end2' ORDER BY sn");
                                            ...
                                            $stmt = $db->query("SELECT ad.*,e.nhis_no,e.surname,e.fname,e.oname,e.phone,e.age,e.gender FROM admission ad 
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php
                                                                $sql = "SELECT test_name, result_note FROM lab_manage WHERE patient = :hospital_no AND section = 'Laboratory' AND data_capture_status = 'approve' AND DATE(request_date) BETWEEN :start2 AND :end2";

                                                                $diagnosis = $db->prepare($sql);
                                                                $diagnosis->bindParam(':hospital_no', $hospital_no);
                                                                $diagnosis->bindParam(':start2', $start2);
                                                                $diagnosis->bindParam(':end2', $end2);
                                                                $diagnosis->execute();

                                                                $results = $diagnosis->fetchAll(PDO::FETCH_ASSOC);

                                                                foreach ($results as $row) {
                                                                    echo "Test Name: " . htmlspecialchars($row['test_name']) . ", Result Note: " . $row['result_note'] . "<br>";
                                                                }
                                                            ...
                                                            <td><?php
                                                                ...
                                                                $sql = "SELECT test_name, result_note FROM lab_manage WHERE patient = :hospital_no AND section = 'Radiology' AND data_capture_status = 'approve' AND DATE(request_date) BETWEEN :start2 AND :end2";
