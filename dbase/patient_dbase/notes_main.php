...
<body>
    ...
    <?php if ($hospital_no) : ?>
        ...
        <a href="download.php?hospital_no=<?php echo urlencode($hospital_no); ?>&notes_search=<?php echo urlencode($notes_search); ?>&rights=<?php echo urlencode($filter_rights); ?>&status=<?php echo urlencode($filter_status); ?>&prepared_by=<?php echo urlencode($filter_preparer); ?>" class="download-csv" target="_blank" rel="noopener noreferrer">Download CSV</a>
        <table id="notesTable">
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                <?php foreach ($notes as $i => $note) : ?>
                    <tr>
                        ...
                        <td><?php echo date('jS M Y', strtotime($note['date_entry'])); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
