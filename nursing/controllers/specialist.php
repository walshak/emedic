...
if ( isset( $_POST['search_specialist'] ) ) {
    ...
    $stmt= $db->query("SELECT fullname AS name, id, username  FROM admin_users WHERE (fullname LIKE '%$input_text%' OR username LIKE '%$input_text%') AND rights = 'DR' AND status = 1 ");
