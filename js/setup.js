      ...
      $(document).on('click', '.view_option', function(){  
           ...
           {  
                $.ajax({  
                     url:"fetch.php",  
                     method:"POST",  
                     data:{field_id_opt:field_id_opt}, 
                     success:function(data){  
		 ...
		 //  var res = field_no_option.split("__");
           ...
           {  
                $.ajax({  
                     url:"fetch_set.php",  
                     method:"POST",  
                     data:{field_no_option:field_no_option}, 
                     success:function(data){  
		 ...
		 //  var res = field_no_option.split("__");
           ...
           {  
                $.ajax({  
                     url:"fetch_set.php",  
                     method:"POST",  
                     data:{field_no_values:field_no_values}, 
                     success:function(data){  
	  ...
	  $(document).on('click', '.add_lab_field_options', function(){  
           ...
           {  
                $.ajax({  
                     url:"fetch_set.php",  
                     method:"POST",  
                     data:{field_no_option_add:field_no_option_add}, 
                     success:function(data){  
	   ...
	   $('#view_lab_option_modal').modal('hide'); 
           ...
           {  
                $.ajax({  
                     url:"delete.php",  
                     method:"POST",  
                     data:{option_no_del:option_no_del}, 
                     success:function(data){  
	   ...
	   $('#view_lab_values_modal').modal('hide'); 
           ...
           {  
                $.ajax({  
                     url:"delete.php",  
                     method:"POST",  
                     data:{values_no_del:values_no_del}, 
                     success:function(data){  
	  ...
	  $(document).on('click', '.enable_labTest', function(){ 
           ...
           {  
                $.ajax({  
                     url:"fetch.php",  
                     method:"POST",  
                     data:{enable_labTest_id:enable_labTest_id}, 
                     success:function(data){  
	  ...
	  $(document).on('click', '.disable_labTest', function(){ 
           ...
           {  
                $.ajax({  
                     url:"fetch.php",  
                     method:"POST",  
                     data:{disable_labTest_id:disable_labTest_id}, 
                     success:function(data){  
	   ...
	   $('#edit_lab_body').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     ...
                     success:function(data){  
			swal({ title: 'Success!', text: 'Updated Successfully', timer: 1000 })
	...
	var del_combs_name_id = $(this).attr("id"); 
           ...
           {  
                $.ajax({  
                     url:"delete.php",  
                     method:"POST",  
                     data:{del_combs_name_id:del_combs_name_id}, 
                     success:function(data){  
