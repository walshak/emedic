...
for ($V4jxpnh1o213=1; $V4jxpnh1o213<5; $V4jxpnh1o213++) {
	...
	echo "{ id:'".$V002moyrkidp."',	name:'".$Vqzjmlp1n1ag."',	open:true, isParent:".(( $Vrblbuurk4ga < "2" && ($V4jxpnh1o213%2)!=0)?"true":"false").($Vbyp1k0ptwyl==""?"":((($Vrblbuurk4ga < "2" && ($V4jxpnh1o213%2)!=0)?", halfCheck:true":"").($V4jxpnh1o213==3?", checked:true":"")))."}";
	if ($V4jxpnh1o213<4) {
		echo ",";
	}
}
