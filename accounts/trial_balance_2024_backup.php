...
// Group mapping for visual display
$group_mapping = [
    ...
    'longterm_liabilities' => 'Long-term Liabilities',
    'taxation' => 'Taxation',
    'revenues' => 'Revenues',
    'other_revenues' => 'Other Revenues',
    'cost_of_sales' => 'Cost of Sales',
    'overhead_administrative' => 'Overhead Administrative',
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>MLUTH 2024 Trial Balance</h5>
                        </div>
                        <div class="ibox-content">
                            <div style="margin-bottom: 20px;">
                                <a href="trial_balance.php" class="btn btn-default">
                                    <i class="fa fa-arrow-left"></i> Back to Current Trial Balance
                                </a>
                            </div>

                            <div class="summary-top">
                                <strong>Period:</strong> <?php echo $trial_balance_mluth_2024['period']['start_date']; ?> to <?php echo $trial_balance_mluth_2024['period']['end_date']; ?>
                                <strong>Total Debits:</strong> <?php echo number_format($trial_balance_mluth_2024['totals']['total_debits'], 2); ?>
                                <strong>Total Credits:</strong> <?php echo number_format($trial_balance_mluth_2024['totals']['total_credits'], 2); ?>
                                <strong>Status:</strong> <span style="color: green;">Balanced ✓</span>
                            </div>

                            <div id="chart_groups">
                                <h1>Trial Balance</h1>
                                <h3>For the period starting <?php echo date('d M Y', strtotime($trial_balance_mluth_2024['period']['start_date'])); ?> and ending
                                    <?php echo date('d M Y', strtotime($trial_balance_mluth_2024['period']['end_date'])); ?></h3>
                                ...
                                <table class="trial-table">
                                    ...
                                    <tbody>
                                        <?php $class_idx = 0;
                                        foreach ($trial_balance_mluth_2024['accounts'] as $class_key => $class_data): $class_idx++; ?>
                                            <tr class="trial-class-row" id="trial_class_<?php echo $class_idx; ?>">
                                                <td>
                                                    <span class="toggle-link" id="trial_class_<?php echo $class_idx; ?>_toggle" onclick="toggleTrialSection('trial_class_<?php echo $class_idx; ?>')">&#9660;</span>
                                                    <?php echo strtoupper($class_mapping[$class_key]); ?>
                                                </td>
                                            ...
                                            <?php $group_idx = 0;
                                            foreach ($class_data as $group_key => $group_accounts): $group_idx++; ?>
                                                <tr class="trial-group-row" id="trial_group_<?php echo $class_idx; ?>_<?php echo $group_idx; ?>" data-parent="trial_class_<?php echo $class_idx; ?>">
                                                    <td>
                                                        <span class="toggle-link" id="trial_group_<?php echo $class_idx; ?>_<?php echo $group_idx; ?>_toggle" onclick="toggleTrialSection('trial_group_<?php echo $class_idx; ?>_<?php echo $group_idx; ?>')">&#9660;</span>
                                                        <?php echo $group_mapping[$group_key]; ?>
                                                    </td>
                                                    <td class="amount-cell"></td>
                                                    <td class="amount-cell"></td>
                                                    <td class="balance-cell"></td>
                                                ...
                                                <?php foreach ($group_accounts as $account): ?>
                                                    <tr class="trial-account-row" data-parent="trial_group_<?php echo $class_idx; ?>_<?php echo $group_idx; ?>">
                                                        <td>[<?php echo $account['code']; ?>] <?php echo $account['name']; ?></td>
                                                        <td class="amount-cell"><?php echo number_format($account['debit'], 2); ?></td>
                                                        <td class="amount-cell"><?php echo number_format($account['credit'], 2); ?></td>
                                                        <td class="balance-cell">
                                                            <?php echo number_format($account['balance'], 2); ?>
                                                            <?php if ($account['balance_type'] == 'CR'): ?>
                                                                <span style="color: blue; font-size: 0.8em;"> CR</span>
                                                            <?php else: ?>
                                                                <span style="color: red; font-size: 0.8em;"> DR</span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                    ...
                                    <tfoot>
                                        <tr style="font-weight: bold; background: #f8f9fa; border-top: 2px solid #007bff;">
                                            <td>TOTALS</td>
                                            <td class="amount-cell"><?php echo number_format($trial_balance_mluth_2024['totals']['total_debits'], 2); ?></td>
                                            <td class="amount-cell"><?php echo number_format($trial_balance_mluth_2024['totals']['total_credits'], 2); ?></td>
                                            <td class="balance-cell">
                                                <?php
                                                $difference = $trial_balance_mluth_2024['totals']['total_debits'] - $trial_balance_mluth_2024['totals']['total_credits'];
                                                echo number_format(abs($difference), 2);
                                                if ($difference == 0): ?>
                                                    <span style="color: green; font-size: 0.8em;"> BALANCED</span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    </tfoot>
