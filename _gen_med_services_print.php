...
<a href="patient.php?hosp_no=<?= $hospital_no; ?>">Return (Previous Page)</a>	 &nbsp; : &nbsp; <button class="btn btn-sm btn-primary" onclick="ClickheretoprintDiv('printable_area')"><i class="fa fa-print"></i> Print</button>
